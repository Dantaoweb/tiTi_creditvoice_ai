...
import {
  ...
  UserPlus, Coins, ArrowUpCircle, Loader2, CircleDollarSign,
} from "lucide-react";
...
function CreateGroup({ onDone, onCancel }) {
  const [form, setForm] = useState({ name: "", amount: "", frequency: "weekly", require_approval: true });
  ...
  return (
    <>
      ...
      <div className="metrics-grid" style={{ gridTemplateColumns: "repeat(auto-fill, minmax(130px, 1fr))" }}>
        ...
        <MetricCard label="Members" value={g.active_count} color="blue" />
