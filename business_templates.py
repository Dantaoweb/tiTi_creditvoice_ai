...
INDUSTRY_TEMPLATES = {
    "retail_trading": {
        ...
        "next_steps": [
            ...
            "Send back, cancel, done, or menu whenever you want to leave a step.",
        ],
    ...
    "pharmacy": {
        ...
        "next_steps": [
            ...
            "Use menu or back to leave a feature.",
        ],
    ...
    "school": {
        ...
        "next_steps": [
            ...
            "Use back, done, or menu to leave a flow.",
        ],
    ...
    "salon_beauty": {
        ...
        "next_steps": [
            ...
            "Use menu, back, or cancel to leave a flow.",
        ],
    ...
    "thrift_contribution": {
        ...
        "next_steps": [
            ...
            "Use due for contribution reminders, and menu/back/cancel to leave a flow.",
        ],
