...
INDUSTRY_PRODUCT_CATALOG = {
    ...
    "boutique_clothing": [
        ...
        ("skirt", "clothing"),
        ("blouse", "clothing"),
        ("native wear", "clothing"),
        ("agbada", "clothing"),
        ("suit", "clothing"),
        ("underwear", "clothing"),
        ("ankara", "fabric"),
        ("lace material", "fabric"),
        ("shoe", "footwear"),
        ("sneakers", "footwear"),
        ("sandals", "footwear"),
        ("slippers", "footwear"),
    ...
    "electronics_shop": [
        ...
        ("standing fan", "appliance"),
        ("rechargeable fan", "appliance"),
        ("blender", "appliance"),
        ("microwave", "appliance"),
        ("electric kettle", "appliance"),
        ("pressing iron", "appliance"),
        ("washing machine", "appliance"),
        ("water dispenser", "appliance"),
        ("home theatre", "electronics"),
        ("sound system", "electronics"),
        ("decoder", "electronics"),
        ("cctv camera", "electronics"),
        ("generator", "power"),
        ("stabilizer", "power"),
        ("inverter", "power"),
        ("solar panel", "power"),
        ("extension box", "power"),
        ("light bulb", "accessory"),
    ],
    "cosmetics_shop": [
        ("body cream", "skincare"),
        ...
        ("hair cream", "haircare"),
        ("shampoo", "haircare"),
        ("hair relaxer", "haircare"),
        ("hair extension", "haircare"),
        ("nail polish", "nails"),
    ],
    "spare_parts": [
        ("brake pad", "brakes"),
    ...
    "car_dealer": [
        ...
        ("truck", "vehicle"),
        ("motorcycle", "vehicle"),
        ("tricycle (keke)", "vehicle"),
        ("tokunbo car", "vehicle"),
        ("brand new car", "vehicle"),
        ("car documentation", "service"),
        ("registration / papers", "service"),
    ],
    "clinic": [
        ("glove", "consumable"),
        ("syringe", "consumable"),
...
SERVICE_PRICE_CATALOG = {
    "transport_logistics": [
        ("intra-city delivery", "per drop", 1500),
        ("inter-city delivery", "per trip", 5000),
        ("dispatch service", "per errand", 2000),
        ("haulage", "per trip", 50000),
        ("passenger trip", "per seat", 3000),
        ("bus charter", "per day", 40000),
        ("car hire", "per day", 25000),
        ("truck hire", "per trip", 80000),
        ("waybill / cargo", "per package", 2500),
        ("relocation / moving", "per trip", 60000),
    ],
    "real_estate_rentals": [
        ("agency fee", "per let", 100000),
        ("agreement fee", "per let", 50000),
        ("caution deposit", "refundable", 100000),
        ("shop rent", "per year", 300000),
        ("self-contain rent", "per year", 400000),
        ("2-bedroom flat", "per year", 800000),
        ("3-bedroom flat", "per year", 1200000),
        ("shortlet apartment", "per night", 25000),
        ("event hall", "per day", 150000),
        ("property inspection", "per visit", 5000),
        ("facility management", "per month", 30000),
        ("service charge", "per year", 150000),
    ],
    "professional_services": [
        ("consultation", "per session", 20000),
        ("document typing", "per page", 500),
        ("printing", "per page", 100),
        ("photocopy", "per page", 50),
        ("lamination", "per sheet", 300),
        ("business registration (CAC)", "per name", 25000),
        ("tax filing", "per filing", 15000),
        ("bookkeeping", "per month", 30000),
        ("legal drafting", "per document", 20000),
        ("advisory / retainer", "per month", 50000),
        ("passport photograph", "per set", 1000),
        ("project proposal", "per document", 25000),
    ],
    "thrift_contribution": [
        ("daily contribution", "per day", 500),
        ("weekly contribution", "per week", 2000),
        ("monthly savings", "per month", 10000),
        ("target savings", "per month", 20000),
        ("ajo / esusu", "per round", 5000),
        ("cooperative dues", "per month", 3000),
        ("registration fee", "one-time", 1000),
        ("passbook", "one-time", 500),
    ],
    "laundry": [
        ("shirt",         "wash & iron",  800),
        ("shirt",         "iron only",    400),
